...
print("<b><center><div class='judul'>LIST KATEGORI</div><center><br>");
?>
<!DOCTYPE html>
<html>
    <head>
...
.dr_row2 {
    ...
    <body>
            ...
            <tr>
                ...
                <td class='dr_tabel'><center>ID KATEGORI</center></td>
                <td class='dr_tabel'><center>NAMA KATEGORI</center></td>
            ...
            <tr>
                ...
                <td class='dr_row2'>
                    <a href="edit_kategori.php?id=<?php echo $baris[0] ?>">Edit</a>
                    <a href="delete_kategori.php?id=<?php echo $baris[0] ?>">Delete</a>
                </td>
