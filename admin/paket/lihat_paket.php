...
print("<b><center><div class='judul'>LIST PAKET</div><center><br>");
?>
<!DOCTYPE html>
<html>
    <head>
...
.dr_row2 {
    ...
    <body>
            ...
            <tr>
                ...
                <td class='dr_tabel'><center>ID PAKET</center></td>
                <td class='dr_tabel'><center>NAMA PAKET</center></td>
            ...
            <tr>
                ...
                <td class='dr_row2'>
                    <a href="edit_paket.php?id=<?php echo $baris[0] ?>">Edit</a>
                    <a href="delete_paket.php?id=<?php echo $baris[0] ?>">Delete</a>
                </td>
